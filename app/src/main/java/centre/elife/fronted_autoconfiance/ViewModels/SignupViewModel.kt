...
class SignupViewModel : ViewModel() {
    ...
    fun signup(name: String, lastName: String, address: String, email: String, password: String) {
        viewModelScope.launch {
            try {
                val response = ClientService.signup(name, lastName, address, email, password)
